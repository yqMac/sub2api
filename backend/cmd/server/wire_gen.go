...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	feishuOrgSyncService := service.NewFeishuOrgSyncService(organizationRepository, userRepository)
	organizationHandler := admin.NewOrganizationHandler(organizationService, feishuOrgSyncService)
