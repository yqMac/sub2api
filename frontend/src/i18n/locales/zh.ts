  ...
  admin: {
    ...
    audit: {
      ...
      detail: {
        ...
        truncatedHint: '已截断（共 {total} 字节，显示前 {shown} 字节）',
        copy: '复制',
      },
      settings: {
        master: {
          title: '总开关',
          enabled: '启用审计',
          enabledDesc: '开启后将记录所有 API 请求的内容',
        },
        capture: {
          title: '捕获设置',
          maxRequest: '请求最大字节',
          maxResponse: '响应最大字节',
          captureUpstream: '捕获上游内容',
          captureUpstreamDesc: '同时记录发给上游和上游返回的原始内容',
          classifyResponse: '响应内容分类',
          classifyResponseDesc: '根据响应内容对类型做二次修正（识别代码/脚本/方案）',
        },
        storage: {
          title: '存储管理',
          retention: '保留天数',
          ...
          earliest: '最早记录',
          manualCleanup: '手动清理',
          cleanupConfirm: '确认清理 {days} 天之前的记录？',
        },
        save: '保存设置',
        saved: '设置已保存',
      },
    ...
    organizations: {
      title: '组织架构',
      description: '管理组织/部门/用户关系',
      noOrganizations: '暂无组织，请创建',
      create: '创建组织',
      tenantKey: '租户标识',
      name: '名称',
      type: '类型',
      ...
      feishu: {
        ...
        testConnection: '测试连接',
        testSuccess: '连接成功，共 {count} 个部门',
        testFailed: '连接失败：{error}',
        syncTitle: '同步组织架构',
        syncDesc: '从飞书拉取所有部门和用户，按企业邮箱匹配系统用户，自动建立部门归属关系。',
        syncNow: '立即同步',
        syncing: '同步中...',
        syncResult: '同步结果',
        departmentsSynced: '部门同步',
        usersSynced: '飞书用户',
        usersMatched: '已匹配',
        usersUnmatched: '未匹配',
        lastSync: '上次同步',
        notConfigured: '请先保存飞书凭证',
      },
    },
  },
