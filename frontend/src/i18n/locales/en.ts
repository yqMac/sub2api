export default {
  ...
  admin: {
    ...
    audit: {
      title: 'Audit Logs',
      description: 'View and manage API request audit records',
      tabs: {
        logs: 'Logs',
        settings: 'Settings',
      },
      ...
      detail: {
        ...
        upstreamCaptureDisabled: 'Upstream capture is disabled',
        truncatedHint: 'Truncated ({total} bytes total, showing first {shown})',
        copy: 'Copy',
      },
      settings: {
        master: {
          ...
          enabledDesc: 'When enabled, all API request content will be recorded',
        },
        capture: {
          title: 'Capture Settings',
          maxRequest: 'Max Request Bytes',
          maxResponse: 'Max Response Bytes',
          captureUpstream: 'Capture Upstream',
          captureUpstreamDesc: 'Also record raw content sent to and returned by upstream',
          classifyResponse: 'Classify Response',
          classifyResponseDesc: 'Refine content type classification based on response body',
        },
        storage: {
          title: 'Storage',
          ...
          cleanupConfirm: 'Confirm cleanup of records older than {days} days?',
        },
        save: 'Save Settings',
    ...
    organizations: {
      title: 'Organizations',
      description: 'Manage organizations / departments / user mapping',
      noOrganizations: 'No organizations yet, please create one',
      ...
      feishu: {
        tab: 'Feishu Sync',
        credentials: 'Feishu App Credentials',
        appId: 'App ID',
        appSecret: 'App Secret',
        saveCredentials: 'Save Credentials',
        testConnection: 'Test Connection',
        testSuccess: 'Connected — {count} departments found',
        testFailed: 'Failed: {error}',
        syncTitle: 'Sync Organization',
        syncDesc: 'Pull all departments and users from Feishu, match by enterprise email, and assign department memberships.',
        syncNow: 'Sync Now',
        syncing: 'Syncing...',
        syncResult: 'Sync Result',
        departmentsSynced: 'Departments',
        usersSynced: 'Feishu Users',
        usersMatched: 'Matched',
        usersUnmatched: 'Unmatched',
        lastSync: 'Last sync',
        notConfigured: 'Please save Feishu credentials first',
      },
    },
  },
