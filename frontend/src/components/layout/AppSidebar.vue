...
// [bmai-fork] icons for audit and organization nav items
const AuditIcon = {
  render: () =>
    h(
      'svg',
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/audit', label: t('nav.audit'), icon: AuditIcon },
    { path: '/admin/organizations', label: t('nav.organizations'), icon: OrgIcon },
  ]
